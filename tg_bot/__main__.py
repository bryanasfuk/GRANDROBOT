...
PM_START_TEXT = """
**ʜᴀʟᴏ {}, ᴀᴋᴜ ᴀᴅᴀʟᴀʜ {}!** 
ᴀᴋᴜ ᴅɪ ᴍᴀɴᴀɢᴇ ᴏʟᴇʜ ᴏʀᴀɴɢ ʏᴀɴɢ ꜱᴀɴɢᴀᴛ ɢᴀɴᴛᴇɴɢ ʏᴀɪᴛᴜ ᴏᴡɴᴇʀ ɢʀᴜᴘ @ᴠᴇʀʏʟᴀᴢʏʀɪᴄʜ , ᴊɪᴋᴀ ᴀᴅᴀ ʏᴀɴɢ ᴅɪᴛᴀɴʏᴀᴋᴀɴ ᴍᴀꜱᴜᴋ ꜱᴀᴊᴀ ᴋᴇ ɢʀᴜᴘ ɴʏᴀ.
ᴏʜ ɪʏᴀ ᴊɪᴋᴀ ɪɴɢɪɴ ᴍᴇʟɪʜᴀᴛ ᴍᴏᴅᴜʟᴇ ʙᴏᴛ ᴀᴋᴜ ᴛɪɴɢɢᴀʟ ᴋʟɪᴋ ꜱᴀᴊᴀ /help.
...
TECHNO_IMG = "https://telegra.ph/file/61cc5897223d2587906b5.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="Help",
                                                                       callback_data="help_back".format(bot.username)),
                                                                                   InlineKeyboardButton(text="Tuan Ku",
                                                                       url="t.me/fckyouasshole")],
                                                                                   [InlineKeyboardButton(text="Tambahkan Bot ini Ke Grup mu",
                                                                       url="t.me/{}?startgroup=true".format(bot.username)),
                                                                                   InlineKeyboardButton(text="Source Code",
                                                                       url="https://github.com/bryanasfuk/GRANDROBOT")
                                                                                 ]]))
